...
import '../../css/NewInsurance.css';

function ThankYou(props) {
    const requestnum = localStorage.getItem("requestnum");
                    ...
                    <div id="content">
                        ...
                        <Container className='flex-column'>
                            <center>
                                ...
                                <p id="reuest_number">{requestnum}</p>
                                <p>  We will review your request and will contact you soon!</p>
